...
namespace MVCForum.IOC
{
    ...
    public static class IOCExtensions
    {
        ...
        public static void BindInRequestScopeWith<T1, T2>(this IUnityContainer container, params InjectionMember[] imembers) where T2 : T1
        {
            container.RegisterType<T1, T2>(new HierarchicalLifetimeManager(), imembers);
        }
        public static void BindInRequestScope<T1>(this IUnityContainer container, T1 instance)
        {
            container.RegisterInstance<T1>(instance, new HierarchicalLifetimeManager());
        }
    ...
    public static class UnityMVC3
    {
        ...
        private static IUnityContainer BuildUnityContainer()
        {
            ...
            container.BindInRequestScopeWith<StripeCardService, StripeCardService>(new InjectionConstructor(apiKey));
            container.BindInRequestScopeWith<StripeInvoiceItemService, StripeInvoiceItemService>(new InjectionConstructor(apiKey));
            container.BindInRequestScopeWith<StripeSubscriptionService, StripeSubscriptionService>(new InjectionConstructor(apiKey));
            container.BindInRequestScopeWith<StripeTokenService, StripeTokenService>(new InjectionConstructor(apiKey));
            container.BindInRequestScopeWith<StripeCouponService, StripeCouponService>(new InjectionConstructor(apiKey));
            container.BindInRequestScopeWith<StripeChargeService, StripeChargeService>(new InjectionConstructor(apiKey));
            container.BindInRequestScopeWith<StripeTransferService, StripeTransferService>(new InjectionConstructor(apiKey));
            container.BindInRequestScopeWith<StripeChargeService, StripeChargeService>(new InjectionConstructor(apiKey));
