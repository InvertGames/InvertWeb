...
namespace MVCForum.Data.Context
{
    public class MVCForumContext : DbContext, IMVCForumContext
    {
        ...
        public DbSet<MarketSellerInfo> MarketSeller { get; set; }
        public DbSet<MarketProductDownload> MarketProductDownload { get; set; }
        public DbSet<MarketProductImage> MarketProductImage { get; set; }
        public DbSet<MarketProductVideo> MarketProductVideo { get; set; }
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Configurations.Add(new MarketSellerMapping());
            modelBuilder.Configurations.Add(new MarketProductMapping());
            modelBuilder.Configurations.Add(new MarketProductReviewMapping());
            modelBuilder.Configurations.Add(new MarketProductImageMapping());
            modelBuilder.Configurations.Add(new MarketProductVideoMapping());
            modelBuilder.Configurations.Add(new MarketProductDownloadMapping());
            modelBuilder.Configurations.Add(new MarketProductPurchaseOptionMapping());
            modelBuilder.Configurations.Add(new MarketProductLicenseMapping());
