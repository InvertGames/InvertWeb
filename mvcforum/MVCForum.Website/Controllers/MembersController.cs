    ...
    public partial class MembersController : PageEditController
    {
        ...
        public ActionResult Edit(string id = null)
        {
            using (UnitOfWorkManager.NewUnitOfWork())
            {
                ...
                var user = string.IsNullOrEmpty(id) ? MembershipService.GetUser(Username) : MembershipService.GetUser(new Guid(id));
        ...
        [Authorize]
        public ActionResult CancelSubscription(string id)
        {
            var currentUser = MembershipService.GetUser(Username);
            MarketService.CancelSubscription(currentUser, id);
            ViewBag.Message = "Subscription successfully canceled.";
        ...
        public PartialViewResult SideAdminPanel()
        {
            ...
            return PartialView(new ViewAdminSidePanelViewModel
            {
                CurrentUser = LoggedOnUser, 
